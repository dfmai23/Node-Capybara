...
void    RTC_SCL_1_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the RTC_SCL_1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(RTC_SCL_1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in RTC_SCL_1_SetInterruptMode() function.
     *  @{
     */
        #define RTC_SCL_1_INTR_NONE      (uint16)(0x0000u)
        #define RTC_SCL_1_INTR_RISING    (uint16)(0x0001u)
        #define RTC_SCL_1_INTR_FALLING   (uint16)(0x0002u)
        #define RTC_SCL_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define RTC_SCL_1_INTR_MASK      (0x01u) 
#endif /* (RTC_SCL_1__INTSTAT) */
...
/* SIO registers */
#if defined(RTC_SCL_1__SIO_CFG)
    #define RTC_SCL_1_SIO_HYST_EN        (* (reg8 *) RTC_SCL_1__SIO_HYST_EN)
    #define RTC_SCL_1_SIO_REG_HIFREQ     (* (reg8 *) RTC_SCL_1__SIO_REG_HIFREQ)
    #define RTC_SCL_1_SIO_CFG            (* (reg8 *) RTC_SCL_1__SIO_CFG)
    #define RTC_SCL_1_SIO_DIFF           (* (reg8 *) RTC_SCL_1__SIO_DIFF)
#endif /* (RTC_SCL_1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define RTC_SCL_1_0_INTTYPE_REG 		(* (reg8 *) RTC_SCL_1__0__INTTYPE)
#endif /* (RTC_SCL_1__INTSTAT) */
