...
*
* \funcusage
*  \snippet xbee_mosi_SUT.c usage_xbee_mosi_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet xbee_mosi_SUT.c usage_xbee_mosi_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet xbee_mosi_SUT.c usage_xbee_mosi_Read  
*******************************************************************************/
...
* preferred xbee_mosi_Read() API because the 
* xbee_mosi_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet xbee_mosi_SUT.c usage_xbee_mosi_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: xbee_mosi_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use xbee_mosi_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - xbee_mosi_0_INTR       (First pin in the list)
    *  - xbee_mosi_1_INTR       (Second pin in the list)
    *  - ...
    *  - xbee_mosi_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet xbee_mosi_SUT.c usage_xbee_mosi_SetInterruptMode
    *******************************************************************************/
    void xbee_mosi_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & xbee_mosi_0_INTR) != 0u) 
		{ 
			 xbee_mosi_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet xbee_mosi_SUT.c usage_xbee_mosi_ClearInterrupt
    *******************************************************************************/
