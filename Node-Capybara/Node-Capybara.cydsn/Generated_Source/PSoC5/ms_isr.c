...
void ms_isr_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)ms_isr__INTC_NUMBER] = address;
}
...
cyisraddress ms_isr_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)ms_isr__INTC_NUMBER];
}
