...
#if !(CY_PSOC5A &&\
	 comparator_out__PORT == 15 && ((comparator_out__MASK & 0xC0) != 0))
...
void    comparator_out_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the comparator_out_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(comparator_out__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in comparator_out_SetInterruptMode() function.
     *  @{
     */
        #define comparator_out_INTR_NONE      (uint16)(0x0000u)
        #define comparator_out_INTR_RISING    (uint16)(0x0001u)
        #define comparator_out_INTR_FALLING   (uint16)(0x0002u)
        #define comparator_out_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define comparator_out_INTR_MASK      (0x01u) 
#endif /* (comparator_out__INTSTAT) */
...
/* SIO registers */
#if defined(comparator_out__SIO_CFG)
    #define comparator_out_SIO_HYST_EN        (* (reg8 *) comparator_out__SIO_HYST_EN)
    #define comparator_out_SIO_REG_HIFREQ     (* (reg8 *) comparator_out__SIO_REG_HIFREQ)
    #define comparator_out_SIO_CFG            (* (reg8 *) comparator_out__SIO_CFG)
    #define comparator_out_SIO_DIFF           (* (reg8 *) comparator_out__SIO_DIFF)
#endif /* (comparator_out__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define comparator_out_0_INTTYPE_REG 		(* (reg8 *) comparator_out__0__INTTYPE)
#endif /* (comparator_out__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_comparator_out_H */
