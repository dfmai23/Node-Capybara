...
void    xbee_miso_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the xbee_miso_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(xbee_miso__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in xbee_miso_SetInterruptMode() function.
     *  @{
     */
        #define xbee_miso_INTR_NONE      (uint16)(0x0000u)
        #define xbee_miso_INTR_RISING    (uint16)(0x0001u)
        #define xbee_miso_INTR_FALLING   (uint16)(0x0002u)
        #define xbee_miso_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define xbee_miso_INTR_MASK      (0x01u) 
#endif /* (xbee_miso__INTSTAT) */
...
/* SIO registers */
#if defined(xbee_miso__SIO_CFG)
    #define xbee_miso_SIO_HYST_EN        (* (reg8 *) xbee_miso__SIO_HYST_EN)
    #define xbee_miso_SIO_REG_HIFREQ     (* (reg8 *) xbee_miso__SIO_REG_HIFREQ)
    #define xbee_miso_SIO_CFG            (* (reg8 *) xbee_miso__SIO_CFG)
    #define xbee_miso_SIO_DIFF           (* (reg8 *) xbee_miso__SIO_DIFF)
#endif /* (xbee_miso__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define xbee_miso_0_INTTYPE_REG 		(* (reg8 *) xbee_miso__0__INTTYPE)
#endif /* (xbee_miso__INTSTAT) */
