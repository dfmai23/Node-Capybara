...
*
* \funcusage
*  \snippet xbee_ss_SUT.c usage_xbee_ss_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet xbee_ss_SUT.c usage_xbee_ss_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet xbee_ss_SUT.c usage_xbee_ss_Read  
*******************************************************************************/
...
* preferred xbee_ss_Read() API because the 
* xbee_ss_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet xbee_ss_SUT.c usage_xbee_ss_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: xbee_ss_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use xbee_ss_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - xbee_ss_0_INTR       (First pin in the list)
    *  - xbee_ss_1_INTR       (Second pin in the list)
    *  - ...
    *  - xbee_ss_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet xbee_ss_SUT.c usage_xbee_ss_SetInterruptMode
    *******************************************************************************/
    void xbee_ss_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & xbee_ss_0_INTR) != 0u) 
		{ 
			 xbee_ss_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet xbee_ss_SUT.c usage_xbee_ss_ClearInterrupt
    *******************************************************************************/
